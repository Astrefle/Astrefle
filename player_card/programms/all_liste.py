...
def liste_bonus_guerrier():
    return {'Pyroguerrier': 'Source du foyer:+3F/3T', 'Amphibien': "Force aquatique:+2F/dans l'eau +4F", 'Archer': "Oeil d'hirondelle:C.C/2T", 'Barbare': 'Art du combat:Imparable/3T', 'Electroguerrier': 'Flux rapide::Inniative/Esquive 3T',
            'Coeurdeglace': "Esprit du pôle:pas d'effet d'état", 'Assassin': 'Aile de la nuit:Invisible/3T', 'Chevalier': "Double lame:Peut utiliser deux armes", 'Paladin': 'Onde de vie:soigne (75%PV)', 'Necromancien': 'Diane des déchus:D6 squellete/3T'}
