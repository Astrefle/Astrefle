...
class Crea_Perso:
    ...
    def competencef(self):
        ...
        if comp_r_f == 3:
            ...
            self.competencef = f'-{all_liste.liste_competence_faible()[comp_r_f]} {all_liste.liste_complement(self)[0]} '
        else:
            print(
    ...
    def competencem(self):
        ...
        if comp_r_m == 3:
            ...
            self.competencem = f'-{all_liste.liste_complement(self)[1]} {all_liste.liste_element()[self.classe]} '

        elif comp_r_m == 7:
            print(
                f'-{all_liste.liste_competence_moyen()[comp_r_m]} {all_liste.liste_complement(self)[2]} ')
            self.competencem = f'-{all_liste.liste_competence_moyen()[comp_r_m]} {all_liste.liste_complement(self)[2]}'
        else:
            print(
    ...
    def competencep(self):
        ...
        if comp_r_p == 1 or comp_r_p == 5 or comp_r_p == 4 or comp_r_p == 9:
            ...
            self.competencep = f'-{all_liste.liste_competence_puissant()[comp_r_p]} {all_liste.liste_complement(self)[2]} '
        else:
            print(
    ...
    def inventaire(self):
        ...
        self.inventaire.append(all_liste.liste_metier_livre()[self.metier])
